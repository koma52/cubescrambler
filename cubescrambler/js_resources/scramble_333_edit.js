...
switch (scrambleType) {
	case 'wca':
		scramble_333.getRandomScramble();
		break;
	
	case '3bld':
		scramble_333.get3BLDScramble();
		break;
	...
	case 'edges':
		scramble_333.getEdgeScramble();
		break;
	
	case 'corners':
		scramble_333.getCornerScramble();
		break;

	case 'll':
		scramble_333.getLLScramble();
		break;

	case 'lsll':
		scramble_333.getLSLLScramble();
		break;

	case 'zbll':
		scramble_333.getZBLLScramble();

	case 'zzll':
		scramble_333.getZZLLScramble();
		break;
	
	case 'zbls':
		scramble_333.getZBLSScramble();
		break;
	
	case 'f2l':
		scramble_333.getF2LScramble();
		break;

	case 'lse':
		scramble_333.getLSEScramble();
		break;

	case 'eoline':
		scramble_333.getEOLineScramble();
		break;

	case 'cmll':
		scramble_333.getCMLLScramble();
		break;
	
	case 'cll':
		scramble_333.getCLLScramble();
		break;

	case 'ell':
		scramble_333.getELLScramble();
		break;

	case 'easy_cross':
		scramble_333.getEasyCrossScramble(n);
		break;
